...
public class CarListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listview = (ListView)v.findViewById(R.id.carlist_listview);
        LeaseListviewAdapter adapter = new LeaseListviewAdapter(getActivity(), Information.carLeases);
